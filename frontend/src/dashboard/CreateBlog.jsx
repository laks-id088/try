          ...
          <form onSubmit={handleCreateBlog} className="space-y-6">
            <div className="space-y-2">
              ...
              >
                ...
                <option value="Personal">Personal Growth & Mindfulness</option>
                <option value="Inspiration">Inspiration & Motivation</option>
                <option value="Creativity"> Creativity & Expression</option>
                <option value="Travels">Travel & Experiences</option>
                <option value="Books">Books & Literature</option>
                <option value="Relationship">Relationships & Social Life</option>
                <option value="Lifestyle">Lifestyle & Well-being</option>
